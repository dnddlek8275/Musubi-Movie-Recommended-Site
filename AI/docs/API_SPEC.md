...
**운영 내부 Base URL**: `http://10.30.2.227`
**Port**: 80 (HTTP)

운영 AI API는 프라이빗 서브넷에 있으며 인터넷에 직접 공개하지 않습니다. 운영
Backend는 사설망으로 위 주소를 호출하고, 관리자는 Bastion을 경유해 점검합니다.
로컬 개발에서는 환경에 맞는 AI 주소를 별도로 사용합니다.
